...
<div class="offcanvas offcanvas-end" :class="{show: state.isOffcanvasOpen}" data-bs-scroll="true"
    data-bs-backdrop="false" tabindex="-1" id="yourOrdersOffcanvas" aria-labelledby="yourOrdersOffcanvasLabel">
